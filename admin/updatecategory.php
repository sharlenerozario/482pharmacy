...
<body>
	...
	<div id="data">
		<div class="container">
			...
			<form name="adminform" action="updatec.php" onsubmit="return validateForm()" method="post">
				<label><font size="6">Update category</font></label><br><br>
				<label>	Update category name	</label><br>
				<label><input style="width: 880px"  type="text" name="cname" value="" placeholder="Update category name"><br><br></label>
				<label>	Update category description	</label><br>
				<label>	<TEXTAREA type="text" Name="cdescription" ROWS="7" COLS="120" value=""  placeholder="Update category description"></TEXTAREA></label><br><br>
